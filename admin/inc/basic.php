...
function add_basic_dp_default_options( $dp_default_options ) {
	...
	// Color
	$dp_default_options['primary_color'] = '#d90000';
	$dp_default_options['secondary_color'] = '#d90000';
	$dp_default_options['content_link_color'] = '#d90000';
	...
	// Sidebar
	$dp_default_options['sidebar'] = 'type1';
...
<div id="tab-content-basic">
	...
	<div id="color_pattern">
      ...
      <p><?php _e( 'You can set the colors used in your site in common. You can also set other colors for buttons and navigations with each theme option.', 'tcd-w' ); ?></p>
            ...
            <p><?php _e( 'This color is used for text link font color, archive page pager button color.', 'tcd-w' ); ?></p>
            ...
            <p><?php _e( 'This color is used for the hover color of text links.', 'tcd-w' ); ?></p>
