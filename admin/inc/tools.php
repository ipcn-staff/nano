...
<div class="theme_option_field cf">
	...
	<div class="theme_option_message">
      <p><?php _e( 'By pressing the "export" button, you can download TCD theme options setting file as json file. Example of setting file name: tcd_theme_options-export-WordPress theme "nano_tcd 065" - NANO - 20181127.json "', 'tcd-w' ); ?></p>
