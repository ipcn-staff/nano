...
<footer class="l-footer">
    <article class="l-footer-banner">
        <ul class="p-banner-list l-inner">
            <li class="p-banner-list__item">
                <a href="https://m-bldg.fujimoto5.co.jp/" class="p-banner-list__content--no-gradation">
                </a>
                <img class="p-banner-list__img" src="<?php echoImgPath('common/banner_01.jpg'); ?>">
            </li>
            <li class="p-banner-list__item">
                <a href="https://www.zaisandoc.jp/" class="p-banner-list__content--no-gradation">
                </a>
                <img class="p-banner-list__img" src="<?php echoImgPath('common/banner_02.jpg'); ?>">
            </li>
            <li class="p-banner-list__item">
                <a href="https://www.fujimoto555.com/" class="p-banner-list__content">
                      <span class="p-banner-list__label">
                          株式会社フジモト産業<br>
                          天王寺区・中央区・東成区の<br>
                          売買・賃貸物件情報サイト
                      </span>
                </a>
                <img class="p-banner-list__img" src="<?php echoImgPath('common/banner_03.jpg'); ?>">
            </li>
        </ul>
    </article>
    ...
    <article class="l-footer-nav">
        <div class="l-footer-nav__inner l-inner">
            ...
            <section class="l-footer-nav__item">
                <h2 class="l-footer-nav__title--wide"><a href="https://www.fujimoto555.com/purchase.html"
                                                         target="_blank" rel="noopener">売買物件情報</a></h2>
                <h2 class="l-footer-nav__title--wide"><a href="https://www.fujimoto555.com/rent.html" target="_blank"
                                                         rel="noopener">賃貸物件情報</a></h2>
                <h2 class="l-footer-nav__title--wide"><a href="<?php echoHomeUrl('sell'); ?>">土地・戸建て・マンション・<br>収益物件を売却したい</a>
                </h2>
                <h2 class="l-footer-nav__title--wide"><a href="<?php echoHomeUrl('lease'); ?>">土地・戸建て・マンション・<br>テナント・空き家を貸したい</a>
                </h2>
            </section>
...
<script src="<?php echoAssetsPath('js/accordion.js'); ?>"></script>
<script>
