...
function get_latest_theme_version( $interval ) {
    ...
    $notifier_file_url = 'http://design-plus1.com/notifier_nano.xml';	
    $db_cache_field = 'nano-contempo-notifier-cache';
    $db_cache_field_last_updated = 'nano-contempo-notifier-last-updated';
